...
<body>
    <header class="header">
        ...
        <form class="form-add-student">
            <input class="add-student__input add-student__input-name" type="text" placeholder="Student name"
                name="name">
            <input class="add-student__input add-student__input-surname" type="text" placeholder="Student surname"
                name="surname">
            <input class="add-student__input add-student__input-date" type="date" name="fecha_nacimiento">
            <input class="add-student__input add-student__input-submit" id="form-data-send" type="submit"
    ...
    <section class="students-list-section">
        ...
        <div class="section__student" id="<?= $student['id'] ?>">
            <p class="student__p student__p-id">N°
                <?= $student['id'] ?>
            </p>
            <p class="student__p">
                <?= $student['name'] ?>
            ...
            <p class="student__p">
                <?= $model->studentDateFormatting($student['fecha_nacimiento']) ?>
            </p>
            <div class="student__crud">
                <button class="student-crud__button-delete student-crud__button"><i
                        class="fa-solid fa-trash"></i></button>
                <button class="student-crud__button-edit student-crud__button"><i
